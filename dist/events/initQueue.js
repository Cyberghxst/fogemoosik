...
exports.default = new MusicEventHandler_1.MusicEventHandler({
    name: distube_1.Events.INIT_QUEUE,
    description: "Executed when a queue starts playing.",
    listener(queue) {
        const commands = this.getExtension(ForgeMusic_1.ForgeMusic).commands.get(distube_1.Events.INIT_QUEUE);
        if (!commands)
            return;
